import numpy as np
from Types import Graph, TransitionProbabilities, Binary, List
from Individual import Individual
from Entropy import JSD
from Polarity import polarity
from Parameters import code_length
...
def get_transition_probabilities(ind: Individual, tendency:str) -> TransitionProbabilities:
    """
...
def distort(code: Binary, transition_probability: TransitionProbabilities) -> Binary:
    ...
    transition_probabilities = np.apply_along_axis(lambda x: transition_probability[x],
                                                   0,
                                                   code)
